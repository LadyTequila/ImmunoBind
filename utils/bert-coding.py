...
# 读取 TSV 文件
file_path = "C:/Users/21636/Desktop/ImmunoBind/data/processed/tcr_with_negatives_neg_ratio_2.tsv"  # 修改为你的文件路径
df = pd.read_csv(file_path, sep="\t")  # 尝试使用 ISO-8859-1 编码
...
for cdr3_seq, epitope_seq in tqdm(zip(cdr3_sequences, epitope_sequences), total=len(cdr3_sequences), desc="Encoding sequences"):
...
new_file_name = f"{file_base}_encoded{file_ext}"
